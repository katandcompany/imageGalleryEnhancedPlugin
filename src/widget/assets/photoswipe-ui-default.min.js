...
(function (root, factory) {
  ...
  const PhotoSwipeUI_Default = function (pswp, framework) {
    ...
    const _fitControlsInViewport = function () {
      return (
    ...
    const _openWindowPopup = function (e) {
      e = e || window.event;
      const target = e.target || e.srcElement;
    ...
    const _hasCloseClass = function (target) {
    ...
    const _onMouseLeaveWindow = function (e) {
      e = e || window.event;
    ...
    const _setupFullscreenAPI = function () {
    ...
    const _setupLoadingIndicator = function () {
    ...
    const _applyNavBarGaps = function (item) {
      const gap = item.vGap;
    ...
    const _setupHidingControlsDuringGestures = function () {
